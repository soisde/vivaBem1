...
<body>
	...
	******************************** -->
    ...
    Breadcumb
    ============================== -->
    <div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcrumb-bg.webp">
        <!-- bg animated image/ -->
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row g-0">
                <div class="col-lg-4">
                    <div class="contact-form-thumb">
                        <img src="assets/img/normal/contact1.webp" alt="img">
                    </div>
                </div>
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="portfolio-thumb">
                        <a class="popup-image icon-btn" href="assets/img/instagram/insta_feed1.webp"><i class="far fa-eye"></i></a>
                        <img src="assets/img/instagram/insta_feed1.webp" alt="portfolio">
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="portfolio-thumb">
                        <a class="popup-image icon-btn" href="assets/img/instagram/insta_feed2.webp"><i class="far fa-eye"></i></a>
                        <img src="assets/img/instagram/insta_feed2.webp" alt="portfolio">
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="portfolio-thumb">
                        <a class="popup-image icon-btn" href="assets/img/instagram/insta_feed3.webp"><i class="far fa-eye"></i></a>
                        <img src="assets/img/instagram/insta_feed3.webp" alt="portfolio">
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="portfolio-thumb">
                        <a class="popup-image icon-btn" href="assets/img/instagram/insta_feed4.webp"><i class="far fa-eye"></i></a>
                        <img src="assets/img/instagram/insta_feed4.webp" alt="portfolio">
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="portfolio-thumb">
                        <a class="popup-image icon-btn" href="assets/img/instagram/insta_feed5.webp"><i class="far fa-eye"></i></a>
                        <img src="assets/img/instagram/insta_feed5.webp" alt="portfolio">
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="portfolio-thumb">
                        <a class="popup-image icon-btn" href="assets/img/instagram/insta_feed6.webp"><i class="far fa-eye"></i></a>
                        <img src="assets/img/instagram/insta_feed6.webp" alt="portfolio">
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="portfolio-thumb">
                        <a class="popup-image icon-btn" href="assets/img/instagram/insta_feed7.webp"><i class="far fa-eye"></i></a>
                        <img src="assets/img/instagram/insta_feed7.webp" alt="portfolio">
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="portfolio-thumb">
                        <a class="popup-image icon-btn" href="assets/img/instagram/insta_feed8.webp"><i class="far fa-eye"></i></a>
                        <img src="assets/img/instagram/insta_feed8.webp" alt="portfolio">
                    </div>
                </div>
            </div>
        </div>
